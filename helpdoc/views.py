...
def jsondata(request):
	...
	data={
	'Q':'T1 Holdings/avg,T2 Holdings/avg,Position avg,Settlement Holiday,Others,OverAll',
	'kite':'Holdings,Login,Market watch,Orders,Positions,Charts,Holdings/Orders/Positions,Orders/Positions,OverAll',
	'Pi':'Holdings,Login,Market watch,Orders,Positions,Charts,OverAll',
	'Nest':'Holdings,login,Orders,Positions,OverAll',
	'Main':'Holdings,Orders,Positions,OverAll',
	'All':'All'
	}
